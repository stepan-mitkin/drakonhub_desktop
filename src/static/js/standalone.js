      ...
      try {
        while (true) {
          switch (me.state) {
            ...
            case "3":
              me.state = "4";
              saveDiagram(newPath, diagram).then(
                function () {
            ...
            case "5":
              if (newPath === unit.currentFilename) {
                ...
                me.state = "3";
                removeFromRecent(unit.currentFilename).then(
                  function () {
                    _main_saveMyFile(__resolve, __reject);
                  },
                  function (error) {
      ...
      try {
        while (true) {
          switch (me.state) {
            case "2":
              me.state = "5";
              loadKeyValue(newName + ".drakon").then(
                function (__returnee) {
                  drakon = __returnee;
            ...
            case "5":
              if (drakon) {
                ...
                me.state = "6";
                loadKeyValue(newName + ".graf").then(
                  function (__returnee) {
                    graf = __returnee;
                    _main_confirmRename(__resolve, __reject);
                  },
            ...
            case "6":
              if (graf) {
                ...
                me.state = "7";
                loadKeyValue(newName + ".free").then(
                  function (__returnee) {
                    free = __returnee;
                    _main_confirmRename(__resolve, __reject);
                  },
      ...
      try {
        while (true) {
          switch (me.state) {
            case "2":
              me.state = "_item2";
              openFileByPath(unit.currentFilename).then(
                function (__returnee) {
                  file = __returnee;
    ...
    function _main_findDiagram(__resolve, __reject) {
      try {
        while (true) {
          switch (me.state) {
            case "2":
              filenames = [name + ".drakon", name + ".free", name + ".graf"];
              _var2 = filenames;
              _var3 = 0;
              me.state = "9";
              break;
        ...
        while (true) {
          switch (me.state) {
            case "2":
              ...
              me.state = "14";
              saveDiagram(fullPath, diagram).then(
                function () {
        ...
        while (true) {
          switch (me.state) {
            case "2":
              ...
              me.state = "203";
              widgets
                .uploadFile(prompt, accept, function () {})
                .then(
                  function (__returnee) {
                    upload = __returnee;
            ...
            case "192":
              ...
              me.state = "_item7";
              saveKeyValue(filename, content).then(
                function () {
                  _main_openFile(__resolve, __reject);
                },
                function (error) {
      ...
      try {
        while (true) {
          switch (me.state) {
            case "2":
              me.state = "4";
              loadKeyValue("drlauncher-recent").then(
                function (__returnee) {
        ...
        while (true) {
          switch (me.state) {
            ...
            case "2":
              ...
              me.state = "1";
              dh2common.loadStringsForLanguage(settings.language).then(
                function () {
        ...
        while (true) {
          switch (me.state) {
            ...
            case "2":
              ...
              me.state = "1";
              saveKeyValue("drlauncher-recent", _var2).then(
                function () {
          ...
          switch (me.state) {
            ...
            case "10":
              if (unit.recent.length > maxRecent) {
                ...
                me.state = "10";
                removeKeyValue(oldest.path).then(
                  function () {
      ...
      try {
        while (true) {
          switch (me.state) {
            case "2":
              me.state = "4";
              dh2common.loadStringsForLanguage(language).then(
                function () {
            ...
            case "25":
              if (unit.currentFilename) {
                if (unit.currentFilename === data.key) {
                  ...
                  me.state = "51";
                  loadKeyValue(unit.currentFilename).then(
                    function (__returnee) {
                      diagram = __returnee;
